...
import com.kakaoscan.server.infrastructure.exception.NoSuchEventException;
...
public class RedisEventStatusAdapter implements EventStatusPort {
    ...
    public EventStatus getEventStatus(String eventId) {
        ...
        if (eventStatus != null) {
            ...
            throw new NoSuchEventException("no such event id: " + eventId);
        }
    }

    @Override
    public <T extends EventMetadata> EventStatus getEventStatus(T event) {
